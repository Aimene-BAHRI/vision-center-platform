  ...
  return (
    <footer className="bg-vc-dark text-vc-silver border-t border-white/10">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* Brand */}
        <div>
          <p className="font-heading text-vc-white text-xl mb-1">
            Vision Center
          </p>
          <p className="text-vc-teal text-xs tracking-widest uppercase mb-3">
            Khouane Yacine
          </p>
        ...
        <div className="flex flex-col gap-3">
          <p className="text-vc-white text-xs tracking-widest uppercase mb-1">
            {t("nav_heading")}
          </p>
          <a
            href="#services"
            className="text-sm hover:text-vc-teal transition-colors"
          >
            {tNav("services")}
          </a>
          <Link
